...
export function initializeReview(){
 ...
 let barcodeStyleEnrolled=false;try{barcodeStyleEnrolled=localStorage.getItem('og-design:barcode-style:v1')==='done';}catch{}
 if(!barcodeStyleEnrolled)states['board-barcode-main']='pending';
 ...
 if(!membershipEnrolled)states['board-my-info-membership']='pending';
 let profileEnrolled=false;try{profileEnrolled=localStorage.getItem('og-design:account-profile:v1')==='done';}catch{}
 if(!profileEnrolled)states['board-my-info-account']='pending';
