...
export function initializeReview(){
 ...
 let barcodeV3Cases=false;try{barcodeV3Cases=localStorage.getItem('og-design:barcode-v3-cases:v1')==='done';}catch{}
 if(!barcodeV3Cases)states['board-barcode-v3']='pending';
