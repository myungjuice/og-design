...
export function textarea({id=uid('textarea'),label='',labelHTML='',value='',placeholder='',maxLength=200,hint,helpId=id+'-help',countId=id+'-count',attributes={}}={}) {
 return '<div class="og-field"><label for="'+e(id)+'">'+(labelHTML||e(label))+'</label><div class="og-field-control"><textarea id="'+e(id)+'" maxlength="'+e(maxLength)+'" aria-describedby="'+e(helpId)+' '+e(countId)+'" placeholder="'+e(placeholder)+'"'+attrs(attributes)+'>'+e(value)+'</textarea></div><div class="og-field-footer"><p id="'+e(helpId)+'" class="og-field-help">'+e(hint===undefined?'최대 '+maxLength+'자':hint)+'</p><span id="'+e(countId)+'" class="og-field-count">'+String(value).length+' / '+e(maxLength)+'</span></div></div>';
}
